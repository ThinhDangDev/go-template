...
func Load() (Config, error) {
	...
	cfg := Config{
		ServiceName:      envOrDefault("SERVICE_NAME", "go-template"),
		...
		PostgresDB:       envOrDefault("POSTGRES_DB", "go_template"),
		PostgresSSLMode:  envOrDefault("POSTGRES_SSLMODE", "disable"),
		JWTSecret:        strings.TrimSpace(os.Getenv("JWT_SECRET")),
		JWTIssuer:        envOrDefault("JWT_ISSUER", "go-template"),
		...
		LogFile:          envOrDefault("LOG_FILE", "logs/go-template.log"),
